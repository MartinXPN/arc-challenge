...
def gen_hypothesis(data: dict, nb_hypothesis: int = 1) -> list[tuple[str, str]]:
...
def gen_solutions(
    ...
    hypothesis = gen_hypothesis(data, nb_hypothesis)
    logger = get_logger()
...
if __name__ == '__main__':
    ...
    # with open('arc/data/training/2dee498d.json') as f:
    #     data = json.load(f)
    #     preds = gen_solutions(data, nb_hypothesis=1, nb_predictions_per_hypothesis=2)
    #     print('DONE!')
    #     for pred in preds:
